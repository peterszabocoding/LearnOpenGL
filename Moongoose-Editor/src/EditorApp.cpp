...
public:
	EditorApp()
	{
		...
		ShaderManager::AssignShaderToType(ShaderType::GBUFFER, "shader\\shader.vert", "shader\\gbuffer.fs", "");
		...
		ShaderManager::AssignShaderToType(ShaderType::POST_PROCESS_SSR,	"shader\\post_processing.vs", "shader\\post_processing_ssr.fs", "");
