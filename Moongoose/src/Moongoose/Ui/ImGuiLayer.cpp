...
Moongoose::ImGuiLayer::ImGuiLayer(): GuiLayer("ImGuiLayer") {}
...
void Moongoose::ImGuiLayer::onImGuiRender()
{
	static bool show = true;
	ImGui::ShowDemoWindow(&show);
}

void Moongoose::ImGuiLayer::Begin()
{
