...
void GuiWidgets::DrawButtonImage(const Ref<LearnOpenGL::Texture2D>& imageNormal,
	const Ref<LearnOpenGL::Texture2D>& imageHovered, const Ref<LearnOpenGL::Texture2D>& imagePressed, ImU32 tintNormal,
...
void GuiWidgets::ImageButtonWithText(const LearnOpenGL::UUID id, const Ref<LearnOpenGL::Texture2D>& icon, const std::string& text,
